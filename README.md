...
Step28 の実装まで完了した。完了したのだが、これまでの Step の課題には記載がないが、できている前提で書かれている機能がいくつかあり、現状はそれらが未実装になっている。よって、それらを実装していく。
一旦セルフホストまではこぎつけるつもりだが、本当にこの実装でよいのか？感がところどころにあるため、早く目処をつけて chibicc や他の C コンパイラの実装を追いたいところ。
